        ...
        <div className="container">
          <div className="hero-content">
            ...
            <nav className="breadcrumb">
              ...
              <span className="breadcrumb-separator">></span>
              <span className="breadcrumb-current">BLS Course</span>
            </nav>
            ...
            <div className="hero-main">
              ...
              <h1 className="hero-title">Basic Life Support (BLS) Course</h1>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="course-section">
                ...
                <ul className="curriculum-list">
                  ...
                  <li className="curriculum-item">
                    ...
                    <span>The AHA Chain of Survival, specifically the BLS components</span>
                  </li>
                  <li className="curriculum-item">
                    <div className="curriculum-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <span>Important early use of an AED</span>
                  </li>
                  <li className="curriculum-item">
                    <div className="curriculum-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <span>Effective ventilations using a barrier device</span>
                  </li>
                  <li className="curriculum-item">
                    <div className="curriculum-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <span>Importance of teams in multirescuer resuscitation and performance as an effective team member during multirescuer CPR</span>
                  </li>
                  <li className="curriculum-item">
                    <div className="curriculum-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <span>Relief of foreign-body airway obstruction (choking) for adults and infants</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="pricing-card">
                ...
                <div className="pricing-details">
                  <div className="price-item">
                    ...
                    <span className="price-value">$95.00</span>
                  </div>
                  <div className="price-item">
